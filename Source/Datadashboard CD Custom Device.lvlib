...
<Library LVVersion="13008000">
	...
	<Item Name="Datadashboard CD GUID Lookup.vi" Type="VI" URL="../Datadashboard CD GUID Lookup.vi"/>
	<Item Name="Datadashboard CD Initialization VI.vi" Type="VI" URL="../Datadashboard CD Initialization VI.vi"/>
	<Item Name="Datadashboard CD Main Page.vi" Type="VI" URL="../Datadashboard CD Main Page.vi"/>
	<Item Name="Datadashboard CD RT Driver VI.vi" Type="VI" URL="../Datadashboard CD RT Driver VI.vi"/>
	<Item Name="Get DataRef Create SV.vi" Type="VI" URL="../Get DataRef Create SV.vi"/>
